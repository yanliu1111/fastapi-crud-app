...
async def get_book(book_uid: str, session: AsyncSession = Depends(get_session), user_details: str = Depends(access_token_bearer), dependencies=[role_checker]) -> dict:
...
async def update_book(book_uid: str, book_update_data:BookUpdateModel, session: AsyncSession = Depends(get_session),user_details: str = Depends(access_token_bearer)) -> dict:
...
async def delete_book(book_uid: str, session: AsyncSession = Depends(get_session),user_details: str = Depends(access_token_bearer)):
